...
export function PatientCard() {
  return (
    <div className="max-w-lg p-2 space-y-10">
      <div className="group flex min-h-[5rem] overflow-hidden rounded-lg border border-emerald-500 shadow-md">
          ...
          <div>
            ...
            <div className="sm:flex sm:items-end sm:justify-end">
              <div className="space-y-1 pt-0.5">
                <p className="text-slate-600">31 year old Male</p>
